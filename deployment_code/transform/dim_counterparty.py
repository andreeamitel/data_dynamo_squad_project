...
def dim_counterparty(address_table_data, counterparty_table_data):
    """This function takes a two dictionaries from the
    counterparty and address tables and returns amended
    dictionary with key = table name and value list
    for the dim_counterparty table.

    Args:
    'counterparty' and 'address' dictionaries
    Returns:
    dim_counterparty dictionary
    """
