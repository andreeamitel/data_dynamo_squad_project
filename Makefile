...
PROJECT_NAME = data_dynamo_squad_project
REGION = eu-west-2
...
## Run the unit tests
unit-test:
	$(call execute_in_env, PYTHONPATH=${PYTHONPATH} pytest --testdox -vrP)
...
## Run all checks
run-checks: run-flake security-test unit-test check-coverage
